    ...
    <footer id="kontak" className="bg-slate-950 border-t border-cyan-900/30 text-slate-400 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-700 flex items-center justify-center text-slate-950 font-bold shadow-lg shadow-cyan-500/20">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 font-mono text-xs">
              ...
              <div className="p-3 rounded-xl bg-slate-900/80 border border-cyan-900/40 hover:border-cyan-500/60 transition-colors">
                ...
                <p className="text-slate-300">156.600 MHz (Operasional VTS & Pelabuhan)</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-300">
              <div className="flex items-start space-x-3">
                ...
                <span>
                  Jl. Yos Sudarso No. 104, Pelabuhan Panjang, Kota Bandar Lampung, Lampung 35241, Indonesia
                </span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="mt-12 pt-6 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 space-y-4 md:space-y-0">
          <p>© {new Date().getFullYear()} Stasiun VTS Panjang - Distrik Navigasi Kelas I Panjang. Hak Cipta Dilindungi Undang-Undang.</p>
          <div className="flex items-center space-x-4 font-mono text-[11px]">
            <span>LAT: 05° 28' 28.56" S</span>
            <span>LONG: 105° 18' 51.12" E</span>
          </div>
        </div>
      </div>
    </footer>
